...
//line pages.gsx:20:4
			...
			_gsxgw.S("\"")
			_gsxv1, _gsxerr := idTarget(ctx, index.TodoList)
			if _gsxerr != nil {
				return _gsxerr
			}
			_gsxgw.S(" hx-target=\"")
...
//line pages.gsx:36:4
			_gsxgw.S("<div")
			_gsxv2, _gsxerr := idFor(ctx, index.TodoList)
			if _gsxerr != nil {
				return _gsxerr
			}
			_gsxgw.S(" id=\"")
...
//line pages.gsx:90:6
			...
			_gsxv3, _gsxerr := urlFor(ctx, toggle{}, "id", todo.ID)
			if _gsxerr != nil {
				return _gsxerr
			}
			_gsxgw.S(" hx-post=\"")
			...
			_gsxgw.S("\"")
			_gsxv4, _gsxerr := idTarget(ctx, index.TodoList)
			if _gsxerr != nil {
				return _gsxerr
			}
			_gsxgw.S(" hx-target=\"")
...
//line pages.gsx:99:5
			...
			_gsxv5, _gsxerr := urlFor(ctx, deleteTodo{}, "id", todo.ID)
			if _gsxerr != nil {
				return _gsxerr
			}
			_gsxgw.S(" hx-delete=\"")
			...
			_gsxgw.S("\"")
			_gsxv6, _gsxerr := idTarget(ctx, index.TodoList)
			if _gsxerr != nil {
				return _gsxerr
			}
			_gsxgw.S(" hx-target=\"")
